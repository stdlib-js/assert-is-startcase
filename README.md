...
*   <span class="package-name">[`@stdlib/assert-is-startcase`][main-url]</span><span class="delimiter">: </span><span class="description">Test if a value is a startcase string.</span>
